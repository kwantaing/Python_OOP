...
Jeff.make_deposit(25).make_deposit(50).make_deposit(25).make_withdrawal(30)
print("Jeff's account balance: $", Jeff.account_balance)

#Have the second user make 2 deposits and 2 withdrawals 
Bob.make_deposit(50).make_deposit(25).make_withdrawal(10).make_withdrawal(15)
print("Bob's account balance: $",Bob.account_balance)

#Have the third user make 1 deposits and 3 withdrawals
Jenn.make_deposit(120).make_withdrawal(15).make_withdrawal(25).make_withdrawal(8)
...
Jeff.transfer_money(Jenn,30).transfer_money(Bob,20)